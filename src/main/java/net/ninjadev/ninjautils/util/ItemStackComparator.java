...
public class ItemStackComparator {
    ...
    public static void init() {
        ...
        for (ItemGroup cachedGroup : cachedGroups) {
            cachedGroup.updateEntries(new ItemGroup.DisplayContext(ServerSetup.SERVER.getCommandSource().getEnabledFeatures(), false, ServerSetup.SERVER.getRegistryManager()));
        }
    }
