...
public class InventorySaveState extends PersistentState {
    ...
    protected static final String DATA_NAME = Constants.SERVER_MOD_ID + "_inventorySave";
    ...
    public void restore(ServerPlayerEntity player, int index) {
        ...
        Constants.LOG.info("Restoring inventory for player: {}", player.getName());
        ...
        Constants.LOG.info("Inventory restored.");
    }
