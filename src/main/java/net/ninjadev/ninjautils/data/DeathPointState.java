...
public class DeathPointState extends PersistentState {
    ...
    protected static final String DATA_NAME = Constants.SERVER_MOD_ID + "_deathpoints";
    ...
    public void addEntry(UUID playerId, Entry entry) {
        ...
        DeathPointFeature deathpointFeature = ServerConfigs.FEATURES.getFeature(DeathPointFeature.NAME);
    ...
    public static class Entry implements Comparable<Entry> {
        ...
        public Optional<World> getWorld() {
            ...
            return Optional.ofNullable(ServerSetup.SERVER.getWorld(this.getWorldKey()));
        }
