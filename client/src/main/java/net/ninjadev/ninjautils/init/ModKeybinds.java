...
public class ModKeybinds {
    ...
    private static final KeyBinding.Category CATEGORY = KeyBinding.Category.create(Identifier.of(SharedConstants.CLIENT_MOD_ID, "general"));
    ...
    private static KeyBinding createKeyBinding(String name, int key) {
        KeyBinding keyBind = new KeyBinding("key." + SharedConstants.CLIENT_MOD_ID + "." + name, key, CATEGORY);
