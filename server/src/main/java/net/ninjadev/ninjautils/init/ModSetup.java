...
public class ModSetup {
    ...
    public static void registerLifecycleEvents() {
        ServerLifecycleEvents.SERVER_STARTING.register(server -> ModFeatures.init());
        ...
        ServerLifecycleEvents.BEFORE_SAVE.register((server, flush, force) -> ModConfigs.saveAll());
    }
}
